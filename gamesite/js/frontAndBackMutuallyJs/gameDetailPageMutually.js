...
//            contentType:'application/json',
    ...
    function firsNewShow(value) {
        ...
        firstNewsImg.src="/ccnb/"+value.newsImg;
    }
}
            ...
            success: function (data) {
                ...
                $.each(data.rows, function(n, value) {
                    ...
                    fightTreamList.innerHTML=fightTreamList.innerHTML
                        +'<div class="fightTeamitem fondcolor_255-255-255">'
                        +'<div>'
                        +'<img class="gamelogoimgmiddle" src="/ccnb/'+value.logo+'">'
                        +'</div>'
                        +'</div>';
